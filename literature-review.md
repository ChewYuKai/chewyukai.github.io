  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">Entropic GANs meet VAEs: A Statistical Approach to Compute Sample Likelihoods
        in GANs</td>
      <td style="text-align:left">
        <p>GANs is trained by aligning observed with generated distribution. However,
          the lack of explicit probability models in GANs limits their use in statistical
          inference i.e. sample likelihood and posterior probability.</p>
        <p>Don&apos;t understand the maths, it seems interesting.</p>
      </td>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>This paper touch on the fact that Convolution layers focus very much of
          textures instead of geometric cues. For example, a dog generated by GAN
          can have realistic fur, but is missing a legs or have a distorted ear.</p>
        <p>Self-attention GANs will take a point in an image and retrieve complementary
          features or attention maps at distanced portion of the image. This way,
          self-attention GANs can coordinate fine-grain details across semantically
          related regions.</p>
        <p>This paper is using attention modules in &quot;attention is all you need&quot;
          paper from the NLP literature for GANs</p>
        <p>As mentioned in the results, the inception score is an improvement of
          state of the art. Perhaps, like my deep learning prof said, this year is
          the year of attention.</p>
      </td>
