...
| Few-Shot Adversarial Learning of Realistic Neural Talking Head Models | This paper adopts the idea of meta-learning for synthesizing talking head of various actors, with few example images. The core idea is to conduct a lengthy training of the network on person-generic parameters, following by a few-shot transfer learning to person-specific parameters. The main limitation of this technique is the need for landmark adaption, as a different people have obviously different features. I believe that the few-shot capability of this network, is constrainted to only talking head models due to the fundamental limitation of the applied meta-learning. | [https://arxiv.org/pdf/1905.08233.pdf](https://arxiv.org/pdf/1905.08233.pdf) |
| Adversarial feature learning | Bi-directional GAN | [https://arxiv.org/pdf/1605.09782.pdf](https://arxiv.org/pdf/1605.09782.pdf) |
| Semantic Image Synthesis with Spatially-Adaptive Normalization | The innovation of this paper is the introduction of SPADE, which produce better quality images from semantic representation. The innovation seems to be problem specific. | [https://arxiv.org/pdf/1903.07291.pdf](https://arxiv.org/pdf/1903.07291.pdf) |
...
| StarGAN: Unified Generative Adversarial Networks for Multi-Domain Image-to-Image Translation |  | [https://arxiv.org/pdf/1711.09020.pdf](https://arxiv.org/pdf/1711.09020.pdf) |
| A Style-Based Generator Architecture for Generative Adversarial Networks | StyleGAN allows users to control a wide range of style level features via AdaIn on each convolutional layer. This paper also introduce style-mixing, by assigning the parts of two latent code into high-level or low-level styles respectively. The author demonstrates that they are able to get high-level style from one image and low-level style from another via style-mixing | [https://arxiv.org/pdf/1812.04948.pdf](https://arxiv.org/pdf/1812.04948.pdf) |
